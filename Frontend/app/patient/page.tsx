...
export default function PatientHome() {
  ...
  useEffect(() => {
    setWeekStatus(getCurrentWeekStatus(PATIENT_ID));
  }, []);
  ...
  return (
    <main className="min-h-screen bg-white p-6">
      <div className="mx-auto max-w-md">
        ...
        <h1 className="mt-4 text-2xl font-bold text-slate-900">Parivo Health</h1>
        ...
        {/* <div className="mt-6 grid grid-cols-2 gap-3">
          ...
          >
            ...
            <h2 className="mt-1 font-semibold text-slate-900">Motion</h2>
            <p className="text-xs text-slate-600">IMU tremor / gait</p>
          </Link>
          <Link
            href="/patient/checkin"
            className="rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-center hover:border-emerald-800"
          >
            <p className="text-2xl">🎙️</p>
            <h2 className="mt-1 font-semibold text-slate-900">Voice</h2>
            <p className="text-xs text-slate-600">Claude conversation</p>
          </Link>
          <Link
            href="/patient/vision-api"
            className="rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-center hover:border-emerald-800"
          >
            <p className="text-2xl">🎙️</p>
          ...
          {weekStatus === null ? (
            ...
            <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-4">
              ...
              <p className="text-sm text-emerald-800">
                You&apos;ve finished this week&apos;s session. Come back next Monday.
              </p>
            </div>
          )}
